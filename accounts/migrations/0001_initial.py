    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(max_length=100, unique=True, verbose_name='전화번호')),
                ('dept_name', models.CharField(max_length=100, verbose_name='부서')),
                ('team_name', models.CharField(max_length=100, verbose_name='팀명')),
                ('rank_name', models.CharField(max_length=100, verbose_name='직급')),
